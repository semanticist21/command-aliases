---
name: agent-review
description: Review the current task with independent agents once or in a strict repeat-until-clean loop.
---

# Agent review

Use standard `review` mode unless the user requests repeated review, unanimity, or a loop. For loop mode, read and follow [references/loop.md](references/loop.md); it overrides the standard confirmation threshold and is the only authority to apply loop findings.
