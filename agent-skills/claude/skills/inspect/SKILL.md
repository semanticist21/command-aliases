...
End with scope inspected, methods/checks, findings count by severity, residual limits, and a handoff order. Do not pad with style nits, rewrite one-diff review into inspect, or weaken evidence to manufacture findings.
